<template>
  <section class="h-[80vh] py-8 flex items-center justify-center">
    ...
    <div class="flex flex-col items-center">
        ...
        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Muhsinbek Mirzamatov</h5>
        <span class="text-sm text-gray-500 dark:text-gray-400">Web Developer</span>
    </div>
</div>
<div class="w-full py-2 max-w-80 opacity-90 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div class="flex flex-col items-center ">
        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="https://avatars.mds.yandex.net/i?id=49e0128d8e21c4e148d75404725d6140d84cbbe6-10350400-images-thumbs&n=13" alt="Bonnie image"/>
...
<style scoped>
    section{
  /* background-image: url("../../img/plantGif.gif"); */
